<%-- 
    ...
    Created on : Dec 30, 2020, 6:27:21 PM
    Author     : Denisa
--%>
...
<t:pageTemplate pageTitle="AddJob">
    <body style="background-color:gainsboro">
        
        <h1> Here, ${pageContext.request.remoteUser}, you can add a job </h1>
        <form class="needs-validation" novalidate method="POST" action="${pageContext.request.contextPath}/AddJob"  style="background-image: url('b.jpg')";>
            <div class=row">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="custom-select d-block w-100" id="availability" name="availability" required>
            ...
            <div class=row">
                <div class="col-md-6 nb-3">
                    <label for="numberInNeed">The number of necessary people</label>
                    <input type="text" class="form-control" id="numberInNeed" name="numberInNeed" placeholder="" value="" required>
                    <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="user">The person who added the job</label>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="approval">Approval (director only)</label>
                    <select class="custom-select d-block w-100" id="approval" name="approval" required>
                        <option value="">Choose...</option>
            ...
            <div><label></label></div>
            <button class=" btn btn-primary btn-lg btn-block" type="submit">Add job position</button>
           <div><label></label></div>
