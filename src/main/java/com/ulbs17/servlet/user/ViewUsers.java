...
@ServletSecurity(
        value = @HttpConstraint(rolesAllowed = {"AdministratorRole", "DirectorGeneralAndRecruiterRole"}))
public class ViewUsers extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.setAttribute("activePage", "ViewUsers");

        List<UserDetails> users = userBean.getAllUsers();
        request.setAttribute("users", users);
        request.getRequestDispatcher("/WEB-INF/Pages/viewUsers.jsp").forward(request, response);
    }
