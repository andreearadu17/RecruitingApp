...
@ServletSecurity(
        value = @HttpConstraint(rolesAllowed = {"DirectorRole"}))
public class AddComment extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        CandidateDetails cand = candidateBean.findById(candId);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String candIdAsString = request.getParameter("candidate_id");
        int candId = Integer.parseInt(candIdAsString);
        candidateBean.addComment(candId, comment);

        response.sendRedirect(request.getContextPath() + "/ViewCandidates");
